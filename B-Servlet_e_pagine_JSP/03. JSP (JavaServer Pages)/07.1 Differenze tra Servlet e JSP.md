...
| Prestazioni              | Dirette                        | Conversione in Servlet al deploy |
...
- Separazione tra logica e presentazione (pattern MVC)
...
- Separare il più possibile codice Java e markup HTML (pattern MVC).
...
- Limiti: rischio di mischiare logica e presentazione se non si seguono le best practice.
